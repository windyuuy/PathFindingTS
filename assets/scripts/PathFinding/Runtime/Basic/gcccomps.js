...
(function (gcc) {
    ...
    (function (respool) {
        var MyNodePool = /** @class */ (function () {
            ...
            MyNodePool.loadAsync = function (prefabId) {
                return __awaiter(this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                _this.load(prefabId, function (node, err) {
                                    if (err) {
                                        reject(err);
                                    }
                                    else {
            ...
            MyNodePool.loadPrefabAsync = function (prefabId) {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    _this.loadPrefab(prefabId, function (prefab, err) {
                        if (err) {
                            reject(err);
                        }
                        else {
