...
declare namespace CANNON {
    ...
    class Narrowphase {
        ...
        public getContacts(p1: Body[], p2: Body[], world: World,
            result: ContactEquation[], oldcontacts: ContactEquation[],
            frictionResult: FrictionEquation[], frictionPool: FrictionEquation[]
        ): void
        public testContacts(p1: Body[], p2: Body[], world: World,
            result: ContactEquation[], oldcontacts: ContactEquation[],
            frictionResult: FrictionEquation[], frictionPool: FrictionEquation[]
        ): boolean
    ...
    export interface OverlapKeeper {

        current: number[];
        previous: number[];

        getKey(i: number, j: number): void
